...
################################################################################
## Form generated from reading UI file 'template - Copie.ui'
##
...
"")
        ...
        self.pushButton.setStyleSheet(u"nimage: url(:/newPrefix/template_icon.png);\n"
"border-image: url(:/newPrefix/template_icon.png);\n"
"border-radius: 12px;\n"
"")
